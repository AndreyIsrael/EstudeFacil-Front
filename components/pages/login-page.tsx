...
export default function LoginPage({ onLogin, onBackHome }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center px-4">
      ...
      <div className="absolute top-0 left-0 w-32 h-32 bg-blue-600 rounded-full" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl w-full relative z-10">
        ...
        <div className="max-w-md w-full bg-gray-200 rounded-lg p-8">
          ...
          <p className="text-gray-600 text-sm mb-6">Digite seu e-mail</p>
      ...
      {/* Decorative Blue Circle */}
      <div className="absolute bottom-0 right-0 w-40 h-40 bg-blue-600 rounded-full opacity-20" />
    </div>
  )
}
